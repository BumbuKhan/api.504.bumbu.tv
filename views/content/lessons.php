...
<div class="row">
    ...
    <div class="col-xs-6"
         style="text-align: center; padding: 8px 0; border: 1px #e0e0e0 solid; border-right: none; border-left: none">
        <div id="circle1">
...
if (!empty($lessons)) { ?>
    <div class="list-group">
        <?php foreach ($lessons as $lesson) { ?>
            <a href="<?= Url::toRoute(['content/view-lesson', 'id' => $lesson['id']], true) ?>" type="button"
               class="list-group-item"><b><?= $lesson['title'] ?></b>
