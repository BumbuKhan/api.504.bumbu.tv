...
<code>[<a href="<?=Url::base(true)?>/lessons/1?expand=words" target="_blank"><?=Url::base(true)?>/lessons/1?expand=words</a>]</code> - will return all words which contain in lesson 1 along with it's data <br>
