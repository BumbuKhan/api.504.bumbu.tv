...
--
-- Хост: localhost:3306
-- Время создания: Май 31 2017 г., 14:01
...
(121, 19, 'harvest', 'gathering in of grain or other food crops', 'This year''s *harvest* was **adequate** to feed all our people.', 'The farmer decided to **expand** his fields so that he would get a bigger *harvest*.', 'If the *harvest* is poor, there is always the possibility of a **famine**.', 1, '0'),
(122, 19, 'abundant', 'more than enough; very plentiful', 'It is **urgent** that the hospital have an *abundant* supply of blood.', 'An *abundant* **harvest** was **predicted** by the secretary of agriculture.', 'In **recent** years an *abundant* number of complaints have disturbed the telephone company.', 2, '0'),
(123, 19, 'uneasy', 'restless; disturbed; anxious', 'Mrs. Spinner was *uneasy* about letting her son play in the **vicinity** of the railroad tracks.', 'The treasurer was *uneasy* about the company''s **budget**.', 'Arnold felt *uneasy* about the meeting even though he tried to act in a **casual** manner.', 3, '0'),
(124, 19, 'calculate', 'find out by adding, subtracting, multiplying, or dividing; figure', 'The cook had to *calculate* the number of diners to see whether he could **decrease** his order for meat.', 'In order to see how **expensive** the car was, the buyer *calculated* the tax and other charges.', 'I used an abacus to *calculate* my average.', 4, '0'),
(125, 19, 'absorb', 'take in or suck up (liquids); interest greatly.', 'The sponge *absorbed* the beer which had leaked from the **keg**.', 'Our bodies must *absorb* those things which will **nourish** them.', 'I became *absorbed* in what the teacher was saying and did not hear the bell ring.', 5, '0'),
(126, 19, 'estimate', 'form a judgment or opinion about; guess', 'The driver *estimated* that the auto race would **commence** at nine o''clock.', 'I try to **avoid** making *estimates* on things I know nothing about.', 'In your *estimate*, who will be **victorious** in this **conflict**?', 6, '0'),
(127, 19, 'morsel', 'a small bite; mouthful; tiny amount', 'When Reynaldo went into the restaurant, he **pledged** to eat every *morsel* on his plate.', 'Suzanne was **reluctant** to try even a *morsel* of the lobster.', 'If you had a *morsel* of intelligence, you would be **uneasy**, too.', 7, '0'),
(128, 19, 'quota', 'share of a total due from or to a particular state, district, person, etc.', 'The company **revealed** a *quota* of jobs reserved for college students.', 'There was a *quota* placed on the number of people who could **migrate** here from China.', '.Lieutenant Dugan **doubted** that a *quota* had been placed on the number of parking tickets each police officer was supposed to give out.', 8, '0'),
(129, 19, 'threat', 'sign or cause of possible evil or harm', 'There is always the **horrid** *threat* that my job will be **abolished**.', 'It is **absurd** to think that a tiny bug could be a *threat* to a person.', 'Our English teacher made a *threat* to take away our cell phones.', 9, '0'),
(130, 19, 'ban', 'prohibit; forbid', 'The group **unanimously** voted to *ban* all people who were under six feet.', 'Health officials are trying to **expand** their field in order to *ban* cigarette advertising from newspapers and magazines.', 'I want to *ban* all outsiders from our discussion on **security**.', 10, '0'),
(131, 19, 'panic', 'unreasoning fear; fear spreading through a group of people so that they lose control of themselves', 'The leader of the lost group **appealed** to them not to *panic*.', 'When the danger was **exaggerated**, a few people started to *panic*.', 'The **source** of *panic* in the crowd was a man with a gun.', 11, '0'),
(132, 19, 'appropriate', 'fit; set apart for some special use', 'At an *appropriate* time, the chief promised to **reveal** his plan.', 'The lawn was an *appropriate* setting for Eileen''s wedding.', 'After some *appropriate* prayers, the dinner was served.', 12, '0'),
(133, 29, 'toil', 'hard work; to work hard; move with difficulty', 'The **feeble** old man *toiled* up the hill.', 'After years of *toil*, scientists **disclosed** that they had made progress in controlling the **dreaded** disease.', '**Despite** all his *toil*, Fred never succeeded in reaching his goal.', 1, '0'),
(134, 29, 'blunder', 'stupid mistake; to make a stupid mistake; stumble; say clumsily', 'The **exhausted** boy *blundered* through the woods.', 'Bert''s **awkward** **apology** could not make up for his serious *blunder*.', 'The general''s *blunder* forced his army to a **rapid** retreat.', 2, '0'),
(135, 29, 'daze', 'confuse', 'The **severity** of the blow *dazed* the fighter and led to his defeat.', 'When he **ventured** out of the house at night, the child was *dazed* by the noise and the lights.', '*Dazed* by the flashlight, Maria **blundered** down the steps.', 3, '0'),
(136, 29, 'mourn', 'grieve; feel or show sorrow for', 'Sandra did not **cease** to *mourn* for john Lennon.', 'The entire city *mourned* for the people lost in the **calamity**.', 'We need not *mourn* over **trifles**.', 4, '0'),
(137, 29, 'subside', 'sink to a lower level; grow less', 'After the **excessive** rains stopped, the flood waters *subsided*.', 'The waves *subsided* when the winds **ceased** to blow.', 'Danny''s anger *subsided* when the **culprit** **apologized**.', 5, '0'),
(138, 29, 'maim', 'cripple; disable; cause to lose an arm, leg, or other part of the body', 'Auto accidents *maim* many persons each year.', 'Though he went through an **awesome** experience in the crash, Fred was not seriously *maimed*.', 'Car manufacturers **insist** that seat belts can prevent the *maiming* of passengers in the event of a crash.', 6, '0'),
(139, 29, 'comprehend', 'understand', 'If you can use a word correctly, there is a good chance that you *comprehend* it.', 'You need not be a **pauper** to *comprehend* fully what hunger is.', 'My parents say that they cannot *comprehend* today''s music.', 7, '0'),
(140, 29, 'commend', 'praise; hand over for safekeeping', 'Everyone *commended* the mayor''s **thrifty** suggestion.', 'Florence *commended* the baby to her aunt''s care.', 'The truth is that we all like to be *commended* for good work.', 8, '0'),
(141, 29, 'final', 'coming last; deciding', 'The *final* week of the term is **rapidly** approaching.', 'Jose was **commended** for his improvement in the *final* test.', 'The *final* **censor** of our actions is our own conscience.', 9, '0'),
(142, 29, 'exempt', 'make free from; freed from', 'Our school *exempts* bright pupils from **final** exams.', 'School property is *exempt* from most taxes.', '**Juvenile** offenders are not *exempt* from punishment.', 10, '0'),
(143, 29, 'vain', 'having too much pride in one''s ability, looks, etc.; of no use', 'Josephine is quite *vain* about her beauty.', 'To be perfectly frank, I do not see what she has to be *vain* about.', 'Brian made **numerous** *vain* attempts to reach the doctor by telephone.', 11, '0'),
(144, 29, 'repetition', 'act of doing or saying again', 'The *repetition* of new words in this book will help you to learn them.', 'Any *repetition* of such **unruly** behavior will be punished.', 'After a *repetition* of his costly mistake, Jerry was fired from his job.', 12, '0'),
(145, 39, 'unearth', 'dig up; discover; find out', 'The digging of the scientists *unearthed* a buried city.', 'A plot to **defraud** the investors was *unearthed* by the F.B.I.', 'The museum **exhibited** the vase that had been *unearthed* in Greece', 1, '0'),
(146, 39, 'depart', 'go away; leave; turn away (from); change; die', 'We arrived in the village in the morning and *departed* that night.', 'Stan was **vague** about *departing* from his usual manner of choosing a partner.', 'Vera was **reluctant** to mention that her uncle had long since *departed*.', 2, '0'),
(147, 39, 'coincide', 'occupy the same place in space; occupy the same time; correspond exactly; agree', 'If these triangles were placed one on top of the other, they would *coincide*.', 'Because Pete''s and Jim''s working hours *coincide*, and they live in the same **vicinity**, they **depart** from their homes at the same time.', 'My **verdict** on the film *coincides* with Adele''s.', 3, '0'),
(148, 39, 'cancel', 'cross out; mark so that it cannot be used; wipe out; call off', 'The stamp was only **partially** *canceled*.', 'Because the first shipment contained **defective** parts, Mr. Zweben *canceled* the rest of the order.', 'Having found just the right man for the job, Captain Mellides *canceled* all further interviews.', 4, '0'),
(149, 39, 'debtor', 'person who owes something to another', 'If I borrow a dollar from you, I am your *debtor*.', 'As a *debtor* who had received many favors from the banker, Mr. Mertz was **reluctant** to testify against him.', 'A **gloomy** *debtor''s* prison was once the fate of those who could not repay their loans.', 5, '0'),
(150, 39, 'legible', 'able to be read; easy to read; plain and clear', 'Julia''s handwriting is beautiful and *legible*.', 'Nancy **hesitated** in her reading because the words were **scarcely** *legible*.', 'Our teacher **penalizes** us for compositions that are not *legible*.', 6, '0'),
(151, 39, 'placard', 'a notice to be posted in a public place; poster', 'Colorful *placards* announced an **urgent** meeting.', '*Placards* were placed throughout the neighborhood by **rival** groups.', '**Numerous** *placards* appeared around the city calling for **volunteers**.', 7, '0'),
(152, 39, 'contagious', 'spreading by contact, easily spreading from one to another', 'Scarlet fever is *contagious*.', 'I find that yawning is often *contagious*.', 'Interest in the project was *contagious*, and soon all opposition to it **collapsed**.', 8, '0'),
(153, 39, 'clergy', 'persons prepared for religious work; clergymen as a group', 'We try never to **hinder** the *clergy* as they perform their **sacred** tasks.', 'Friar Tuck was a member of the *clergy* who loved a **jolly** **jest**.', 'The **majority** of the *clergy* felt the new **morality** was a **menace** to society.', 9, '0'),
(154, 39, 'customary', 'usual', 'It was *customary* for wealthy Romans to **recline** while they were dining.', 'The Robin Williams movie received the *customary* **rave** reviews from the critics.', 'The **traitor** **rejected** the *customary* blindfold for the execution.', 10, '0'),
(155, 39, 'transparent', 'easily seen through; clear', 'Window glass is *transparent*.', 'Colonel Thomas is a man of *transparent* honesty and **loyalty**.', 'The **homicide** was a *transparent* case of **jealousy** that got out of hand.', 11, '0'),
(156, 39, 'scald', 'pour boiling liquid over; burn with hot liquid or steam; heat almost to the boiling point', 'Do not **neglect** to *scald* the dishes before drying them.', 'The *scalding* lava pouring from the mountain placed everyone in peril.', 'By being **hasty**, Stella *scalded* her hand.', 12, '0');
